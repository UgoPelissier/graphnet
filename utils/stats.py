...
def load_stats(
    ...
    train_dir = osp.join(data_dir, name, 'processed', 'stats', 'train')
    ...
    val_dir = osp.join(data_dir, name, 'processed', 'stats', 'valid')
    ...
    test_dir = osp.join(data_dir, name, 'processed', 'stats', 'test')
